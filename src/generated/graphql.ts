...
export type GenresForCategoryQuery = { __typename?: 'Query' } & {
  genres?: Maybe<
 ...
 * });
 */
export function useGenresForCategoryQuery(
  baseOptions?: Apollo.QueryHookOptions<
    GenresForCategoryQuery,
    GenresForCategoryQueryVariables
  >
) {
  return Apollo.useQuery<
    GenresForCategoryQuery,
    GenresForCategoryQueryVariables
  >(GenresForCategoryDocument, baseOptions);
}
export function useGenresForCategoryLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GenresForCategoryQuery,
    GenresForCategoryQueryVariables
  >
...
export type GenresForCategoryQueryHookResult = ReturnType<
  typeof useGenresForCategoryQuery
>;
export type GenresForCategoryLazyQueryHookResult = ReturnType<
  typeof useGenresForCategoryLazyQuery
>;
export type GenresForCategoryQueryResult = Apollo.QueryResult<
  GenresForCategoryQuery,
  GenresForCategoryQueryVariables
>;
