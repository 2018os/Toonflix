...
export type MeForProfileQuery = (
  ...
  & { me: (
    { __typename?: 'User' }
    & Pick<User, 'name' | 'email' | 'level' | 'exp'>
    & { status: (
      { __typename?: 'UserStatus' }
      & Pick<UserStatus, 'commentsCount' | 'collectionsCount' | 'likedCollectionsCount'>
    ) }
  ) }
);

export type RandomWebtoonsForRandomQueryVariables = Exact<{ [key: string]: never; }>;


export type RandomWebtoonsForRandomQuery = (
  { __typename?: 'Query' }
...
export type CommentFragment = (
  { __typename?: 'Comment' }
  & Pick<Comment, 'id' | 'message' | 'createdAt'>
  & { writer: (
    { __typename?: 'User' }
    & Pick<User, 'name'>
  ) }
...
export type MeForWithAuthQuery = (
  { __typename?: 'Query' }
  & { me: (
    { __typename?: 'User' }
    & MyProfileFragment
...
export type GenresForFilterQuery = (
  { __typename?: 'Query' }
...
export const CollectionForCollectionDetailDocument = gql`
    query collectionForCollectionDetail($id: ID!, $afterWebtoonId: ID, $afterCommentId: ID) {
  collection(id: $id) {
    id
    title
    description
 ...
 * });
 */
export function useMeForProfileQuery(baseOptions?: Apollo.QueryHookOptions<MeForProfileQuery, MeForProfileQueryVariables>) {
        return Apollo.useQuery<MeForProfileQuery, MeForProfileQueryVariables>(MeForProfileDocument, baseOptions);
      }
export function useMeForProfileLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<MeForProfileQuery, MeForProfileQueryVariables>) {
          return Apollo.useLazyQuery<MeForProfileQuery, MeForProfileQueryVariables>(MeForProfileDocument, baseOptions);
        }
export type MeForProfileQueryHookResult = ReturnType<typeof useMeForProfileQuery>;
export type MeForProfileLazyQueryHookResult = ReturnType<typeof useMeForProfileLazyQuery>;
export type MeForProfileQueryResult = Apollo.QueryResult<MeForProfileQuery, MeForProfileQueryVariables>;
 ...
 * });
 */
export function useRandomWebtoonsForRandomQuery(baseOptions?: Apollo.QueryHookOptions<RandomWebtoonsForRandomQuery, RandomWebtoonsForRandomQueryVariables>) {
        return Apollo.useQuery<RandomWebtoonsForRandomQuery, RandomWebtoonsForRandomQueryVariables>(RandomWebtoonsForRandomDocument, baseOptions);
      }
export function useRandomWebtoonsForRandomLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<RandomWebtoonsForRandomQuery, RandomWebtoonsForRandomQueryVariables>) {
          return Apollo.useLazyQuery<RandomWebtoonsForRandomQuery, RandomWebtoonsForRandomQueryVariables>(RandomWebtoonsForRandomDocument, baseOptions);
        }
export type RandomWebtoonsForRandomQueryHookResult = ReturnType<typeof useRandomWebtoonsForRandomQuery>;
export type RandomWebtoonsForRandomLazyQueryHookResult = ReturnType<typeof useRandomWebtoonsForRandomLazyQuery>;
export type RandomWebtoonsForRandomQueryResult = Apollo.QueryResult<RandomWebtoonsForRandomQuery, RandomWebtoonsForRandomQueryVariables>;
 ...
 * });
 */
export function useMeForWithAuthQuery(baseOptions?: Apollo.QueryHookOptions<MeForWithAuthQuery, MeForWithAuthQueryVariables>) {
        return Apollo.useQuery<MeForWithAuthQuery, MeForWithAuthQueryVariables>(MeForWithAuthDocument, baseOptions);
      }
export function useMeForWithAuthLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<MeForWithAuthQuery, MeForWithAuthQueryVariables>) {
          return Apollo.useLazyQuery<MeForWithAuthQuery, MeForWithAuthQueryVariables>(MeForWithAuthDocument, baseOptions);
        }
export type MeForWithAuthQueryHookResult = ReturnType<typeof useMeForWithAuthQuery>;
export type MeForWithAuthLazyQueryHookResult = ReturnType<typeof useMeForWithAuthLazyQuery>;
export type MeForWithAuthQueryResult = Apollo.QueryResult<MeForWithAuthQuery, MeForWithAuthQueryVariables>;
 ...
 * });
 */
export function useGenresForFilterQuery(baseOptions?: Apollo.QueryHookOptions<GenresForFilterQuery, GenresForFilterQueryVariables>) {
        return Apollo.useQuery<GenresForFilterQuery, GenresForFilterQueryVariables>(GenresForFilterDocument, baseOptions);
      }
export function useGenresForFilterLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GenresForFilterQuery, GenresForFilterQueryVariables>) {
          return Apollo.useLazyQuery<GenresForFilterQuery, GenresForFilterQueryVariables>(GenresForFilterDocument, baseOptions);
        }
export type GenresForFilterQueryHookResult = ReturnType<typeof useGenresForFilterQuery>;
export type GenresForFilterLazyQueryHookResult = ReturnType<typeof useGenresForFilterLazyQuery>;
export type GenresForFilterQueryResult = Apollo.QueryResult<GenresForFilterQuery, GenresForFilterQueryVariables>;